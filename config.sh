...
CONFIG_FEED_kenzok8=y
CONFIG_FEED_liuran001_packages=y
...
# CONFIG_PACKAGE_luci-app-nodogsplash is not set
...
# CONFIG_PACKAGE_luci-app-pcap-dnsproxy is not set
...
# CONFIG_PACKAGE_luci-theme-argon-lr is not set
...
# CONFIG_SING_BOX_BUILD_SHADOWSOCKSR is not set
...
CONFIG_OVERRIDE_PKGS="luci-app-unblockneteasemusic"
# CONFIG_PACKAGE_luci-app-ssr-plus is not set
# CONFIG_PACKAGE_luci-app-openclash is not set
